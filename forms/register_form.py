#Forms were created using the guidace of a 'Learn Flask Login' tutorial and custom vaildaton was added using regex (Neupane, 2021)(UIBakery, no date)
...
# WTForm for creating and validating users
